 ...
 printf( __( 'WordPress %s' ), $display_version ); ?>
		...
		<div class="about__section changelog has-subtle-background-color">
			<div class="column">
				...
				<p>
					<?php
 printf( _n( '<strong>Version %1$s</strong> addressed %2$s bug.', '<strong>Version %1$s</strong> addressed %2$s bugs.', 26 ), '6.6.2', '26' ); ?>
					<?php
 printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), sprintf( esc_url( __( 'https://wordpress.org/support/wordpress-version/version-%s/' ) ), sanitize_title( '6.6.2' ) ) ); ?>
				</p>
				<p>
					<?php
 printf( _n( '<strong>Version %1$s</strong> addressed %2$s bug.', '<strong>Version %1$s</strong> addressed %2$s bugs.', 16 ), '6.6.1', '16' ); ?>
					<?php
 printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), sprintf( esc_url( __( 'https://wordpress.org/support/wordpress-version/version-%s/' ) ), sanitize_title( '6.6.1' ) ) ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
 printf( __( 'Explore the <a href="%1$s">WordPress %2$s Field Guide</a>. Learn about the changes in this release with detailed developer notes to help you build with WordPress.' ), esc_url( __( 'https://make.wordpress.org/core/wordpress-6-6-field-guide/' ) ), '6.6' ); ?>
				</p>
			</div>
			<div class="column">
				<div class="about__image">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
 printf( __( '<a href="%1$s">Read the WordPress %2$s Release Notes</a> for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ), sprintf( esc_url( __( 'https://wordpress.org/documentation/wordpress-version/version-%s/' ) ), '6-6' ), '6.6' ); ?>
				</p>
			</div>
		</div>
