...
>
 ...
 foreach ( $video_types as $type ) : ?>
	...
	<?php
} function wp_print_media_templates() { $class = 'media-modal wp-core-ui'; $alt_text_description = sprintf( __( '<a href="%1$s" %2$s>Learn how to describe the purpose of the image%3$s</a>. Leave empty if the image is purely decorative.' ), esc_url( __( 'https://www.w3.org/WAI/tutorials/images/decision-tree/' ) ), 'target="_blank" rel="noopener"', sprintf( '<span class="screen-reader-text"> %s</span>', __( '(opens in a new tab)' ) ) ); ?>
