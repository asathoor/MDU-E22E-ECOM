...
<table class="links-table">
 ...
 _e( 'friendship' ); ?>
			...
			<input name="friendship" type="radio" class="valinp" value="" id="friendship" <?php xfn_check( 'friendship' ); ?> />&nbsp;<?php  _x( 'none', 'Type of relation' ); ?>
			</label>
		</fieldset></td>
	</tr>
	<tr>
 ...
 _e( 'geographical' ); ?>
			...
			<input class="valinp" type="radio" name="geographical" value="" id="geographical" <?php xfn_check( 'geographical' ); ?> />&nbsp;<?php  _x( 'none', 'Type of relation' ); ?>
			</label>
		</fieldset></td>
	</tr>
	<tr>
 ...
 _e( 'family' ); ?>
			...
			<label for="family">
			<input class="valinp" type="radio" name="family" value="" id="family" <?php xfn_check( 'family' ); ?> />&nbsp;<?php  _x( 'none', 'Type of relation' ); ?>
			</label>
		</fieldset></td>
	</tr>
	<tr>
